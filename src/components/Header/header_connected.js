                            ...
                            {menuItems.map((menuItem, index) => (
                                <li key={index}>
                                    <Link to={menuItem.to} className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                        ...
                                        {menuItem?.number && <span class="inline-flex items-center justify-center w-3 h-3 p-3 ml-3 text-sm font-medium text-primary bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-300">{menuItem.number}</span>}
                                    </Link>
                                </li>
                            ))}
